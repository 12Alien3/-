...
BEGIN_MESSAGE_MAP(CCw092View, CScrollView)
	...
	ON_COMMAND(ID_BFL_FILTER, OnBflFilter)
	ON_UPDATE_COMMAND_UI(ID_BFL_FILTER, OnUpdateBflFilter)
	ON_COMMAND(ID_BFH_FILTER, OnBfhFilter)
	ON_UPDATE_COMMAND_UI(ID_BFH_FILTER, OnUpdateBfhFilter)
	ON_COMMAND(ID_IFL_FILTER, OnIflFilter)
	ON_UPDATE_COMMAND_UI(ID_IFL_FILTER, OnUpdateIflFilter)
	ON_COMMAND(ID_IFH_FILTER, OnIfhFilter)
	ON_UPDATE_COMMAND_UI(ID_IFH_FILTER, OnUpdateIfhFilter)
	//}}AFX_MSG_MAP
...
void CCw092View::OnUpdateBflFilter(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
...
void CCw092View::OnUpdateBfhFilter(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(lpDIB_FT != NULL && is_gFD_OK());
}
...
void CCw092View::OnUpdateIflFilter(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(lpDIB_FT != NULL && is_gFD_OK());
}
...
void CCw092View::OnUpdateIfhFilter(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(lpDIB_FT != NULL && is_gFD_OK());
}
