...
protected:
	...
	afx_msg void OnBflFilter();
	afx_msg void OnUpdateBflFilter(CCmdUI* pCmdUI);
	afx_msg void OnBfhFilter();
	afx_msg void OnUpdateBfhFilter(CCmdUI* pCmdUI);
	afx_msg void OnIflFilter();
	afx_msg void OnUpdateIflFilter(CCmdUI* pCmdUI);
	afx_msg void OnIfhFilter();
	afx_msg void OnUpdateIfhFilter(CCmdUI* pCmdUI);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
